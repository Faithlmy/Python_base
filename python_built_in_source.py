...
def abs(number):  # real signature unknown; restored from __doc__
    ...
    Return value:
    this method returns absolute value of number
...
def all(iterable):  # real signature unknown; restored from __doc__
    ...
    Parameter:
    iterable--> this is iterable(可遍历对象)

    Return value:
    this method returns a value of boolean
    """
    return False
...
def any(iterable):  # real signature unknown; restored from __doc__
    """
    < this is the same as all(), please refer to it >
...
def ascii(p_object):  # real signature unknown; restored from __doc__
    ...
    As repr(), return a string containing(控制，包含) a printable(可印刷的) representation(陈述) of an
...
def bin(number):  # real signature unknown; restored from __doc__
    ...
    Return value:
    this method returns a number of binary
...
def callable(p_object):  # real signature unknown; restored from __doc__
    """
    Description:
    Return whether the object is callable(可被调用的) (i.e., some kind of function).
    ...
    Parameter:
    this parameter is object of functions and  __call__method.

    Return value:
    This method returns a value of boolean. It returns True  if their class has a __call__() method or functions.
...
def chr(i):  # real signature unknown; restored from __doc__
    ...
    Parameter:
    i --> This is a integer number.

    Return value:
    This method returns a value of character whose unicode point is in the integer i.
...
def delattr(p_object, name):  # real signature unknown; restored from __doc__
    ...
    name --> the name of attributes in class
